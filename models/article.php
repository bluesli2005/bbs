...
class article_class extends AWS_MODEL
{
    ...
    public function get_mix_list($category_id,$is_ssl, $uid, $page = 0, $limit)
    {
        ...
        $sql = 'select c.*,c.update_time,d.uid,d.user_name,d.avatar_file from(
			                select e.post_type,a.title,a.id,a.add_time,e.update_time,a.uid,a.comments,a.views,a.votes,
			                ...
			                union all 
			                select f.post_type, b.question_content as title,b.question_id as id,b.add_time,f.update_time,b.published_uid as uid,b.answer_count as comments,
