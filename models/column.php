...
class column_class extends AWS_MODEL
{
	...
	{   
		...
		if($category_ids)
		{
			return $this->sum('article','views',' is_del = 0 and column_id = '.$column_id.' and category_id not in ('.implode(",", $category_ids).')');
		}else
		{
			return $this->sum('article','views',' is_del = 0 and column_id = '.$column_id);
		}
	...
	{   
		...
		if($category_ids)
		{
			return $this->sum('article','votes',' is_del = 0 and column_id = '.$column_id.' and category_id not in ('.implode(",", $category_ids).')');
		}else
		{
			return $this->sum('article','votes',' is_del = 0 and column_id = '.$column_id);
		}
	...
	{   
        ...
        if($category_ids)
		{
			return $this->count('article',' is_del = 0 and column_id = '.$column_id.' and category_id not in ('.implode(",", $category_ids).')');

		}else
		{
			return $this->count('article',' is_del = 0 and column_id = '.$column_id);
		}
