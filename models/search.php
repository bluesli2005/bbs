...
class search_class extends AWS_MODEL
{
	...
	{
        return $this->model('question')->get_by_like($q, $page, $limit, $is_recommend);
	...
	public function prase_result_info($result_info,$q)
	{
		...
		if ($result_type)
		{
			$result_info['uid'] = $result_type == 'questions' ? $result_info['published_uid'] : $result_info['uid'];
			return array(
				'uid' => $result_info['uid'],
				'user_info' => $userinfo,
