...
$config[] = array(
    ...
    'children' => array(
        ...
        array(
            'id' => 901,
            'title' => AWS_APP::lang()->_t('回复管理'),
            'url' => 'admin/comment/answer_list/'
        ),
        array(
            'id' => 902,
            'title' => AWS_APP::lang()->_t('问题评论管理'),
            'url' => 'admin/comment/question_comment_list/'
        ),

        array(
            'id' => 903,
            'title' => AWS_APP::lang()->_t('回复评论管理'),
            'url' => 'admin/comment/answer_comment_list/'
        ),

        array(
            'id' => 904,
            'title' => AWS_APP::lang()->_t('文章评论管理'),
...
$config[] = array(
    ...
    'children' => array(
        ...
        array(
            'id' => 340,
            'title' => AWS_APP::lang()->_t('广告管理'),
            'url' => 'admin/advertising/list/'
        )
...
$config[] = array(
    'title' => AWS_APP::lang()->_t('插件扩展'),
    'cname' => 'job',
    'children' => array(
        array(
            'id' => 1201,
            'title' => AWS_APP::lang()->_t('短信设置'),
            'url' => 'admin/tools/sms/',
        ),
        array(
            'id' => 1202,
            'title' => AWS_APP::lang()->_t('支付设置'),
            'url' => 'admin/tools/pay/',
        )
    )
);
