...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]weixin_accounts` (
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]weixin_msg` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]weibo_msg` (
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]weixin_qr_code` (
...
INSERT IGNORE INTO `[#DB_PREFIX#]system_setting` (`varname`, `value`) VALUES
