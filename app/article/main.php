...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
        ...
        if(get_setting('tip_enabled')=='Y')
			$article_info['shang']=$this->model('reward')->get_shanger($article_info['id'],2);
	...
	public function index_square_action()
	{
		...
		TPL::assign('pagination', AWS_APP::pagination()->initialize(array(
			'base_url' => get_js_url('/article/category-' . $_GET['category'] . '__feature_id-' . $_GET['feature_id']),
