	...
	public function search_action()
	{
		...
		if (!$result)
		{
		    ...
		    foreach ($result as $key=>$val){
                $result[$key]['has_focus'] = $this->model('topic')->has_focus_topic($this->user_id, $val['detail']['topic_id']);
            }
        }
