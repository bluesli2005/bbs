...
class main extends AWS_ADMIN_CONTROLLER
{
    public function index_action()
    {
        ...
        TPL::assign('users_count', $this->model('system')->count('users','is_del != 2'));
        TPL::assign('users_valid_email_count', $this->model('system')->count('users', 'valid_email = 1'));
        TPL::assign('question_count', $this->model('system')->count('question','is_del != 2'));
        TPL::assign('answer_count', $this->model('system')->count('answer','is_del != 2'));
        TPL::assign('question_count', $this->model('system')->count('question','is_del != 2'));
        ...
        $admin_menu=$this->fetch_menu_list();
