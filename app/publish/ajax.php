...
class ajax extends AWS_CONTROLLER
{
    ...
    public function publish_question_action()
    {
        ...
        if ($this->publish_approval_valid(array(
            ...
            $question_id = $this->model('publish')->publish_question($_POST['question_content'], $_POST['question_detail'], $_POST['category_id'], $this->user_id, $_POST['topics'], $_POST['anonymous'], $_POST['attach_access_key'], $_POST['ask_user_id'], $this->user_info['permission']['create_topic'],null,$is_del);
            if ($_POST['_is_mobile']) {
    ...
    public function publish_article_action()
    {
        ...
        if ($this->publish_approval_valid(array(
            ...
            $article_id = $this->model('publish')->publish_article(trim($_POST['title']),$_POST['logo_img'], $_POST['message'], $this->user_id, $_POST['topics'], $_POST['category_id'], $_POST['column_id'], $_POST['attach_access_key'], $this->user_info['permission']['create_topic']);
