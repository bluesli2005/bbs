...
class ajax extends AWS_CONTROLLER
{
    ...
    public function apply_action()
    {
        ...
        H::ajax_json_output(AWS_APP::RSM(['url'=>get_js_url('/column/my/')], 1, AWS_APP::lang()->_t('申请成功')));
    }
    ...
    {
        $column_list = $this->model('column')->get_focus_column_list($this->user_id, intval($_GET['page']) * 10 . ', '.get_setting('index_per_page'));
