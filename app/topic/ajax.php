...
class ajax extends AWS_CONTROLLER
{
	...
	public function save_seo_title_action()
	{
		...
		H::ajax_json_output(AWS_APP::RSM(array(
			'url' => get_js_url('/topic/' . $topic_info['topic_id'])
		), 1, null));
	}
	...
	{
		if ($topics_list = $this->model('topic')->get_focus_topic_list($this->user_id, intval($_GET['page']) * 10 . ', '.get_setting('index_per_page')))
		{
