...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		// {
		// 	HTTP::redirect('/topic/' . $topic_info['topic_id'] . '?rf=' . $_GET['rf']);
		// }
	...
	public function index_square_action()
	{
		...
		//我关注的话题
		if($this->user_id){
			$focus_topics_list = $this->model('topic')->get_focus_topic_list($this->user_id, '0, 11');
			TPL::assign('focus_topics_list', $focus_topics_list);
		}
