...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		if ($_GET['id'])
		{
			...
			$project_info['description'] = html_entity_decode(FORMAT::parse_attachs((FORMAT::parse_markdown($project_info['description']))));
		...
		else
		{
			...
			if ($project_list = $this->model('project')->get_projects_list($_GET['category'], 1, 'ONLINE', $_GET['page'], 9, $order_by))
			{
	...
	public function publish_action()
	{
		if ($_GET['id'])
		{
            ...
            $project_info['description'] = htmlspecialchars_decode($project_info['description']);
