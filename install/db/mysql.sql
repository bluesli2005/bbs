...
(1, 0, 0, '超级管理员', 0, 0, 5, 'a:21:{s:16:"is_administortar";s:1:"1";s:12:"is_moderator";s:1:"1";s:16:"publish_question";s:1:"1";s:21:"publish_approval_time";a:2:{s:5:"start";s:0:"";s:3:"end";s:0:"";}s:13:"edit_question";s:1:"1";s:10:"edit_topic";s:1:"1";s:12:"manage_topic";s:1:"1";s:12:"create_topic";s:1:"1";s:17:"redirect_question";s:1:"1";s:13:"upload_attach";s:1:"1";s:11:"publish_url";s:1:"1";s:15:"publish_article";s:1:"1";s:12:"edit_article";s:1:"1";s:19:"edit_question_topic";s:1:"1";s:15:"publish_comment";s:1:"1";s:14:"publish_column";s:1:"1";s:11:"edit_column";s:1:"1";s:9:"down_flie";s:1:"1";s:10:"is_service";s:1:"1";s:14:"publish_ticket";s:1:"1";s:15:"publish_project";s:1:"1";}'),
...
ALTER TABLE  `[#DB_PREFIX#]question_comments` ADD  `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]article` ADD  `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]article_comments` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]question` ADD  `is_del`  TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]answer` ADD  `is_del`   TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]users` ADD  `is_del`   TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]users_attrib` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]posts_index` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]topic_relation` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]answer_comments` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]notification` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]user_action_history` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]user_action_history_data` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]user_action_history_fresh` ADD    `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
ALTER TABLE  `[#DB_PREFIX#]user_follow` ADD  `is_del` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '是否删除0正常1删除';
...
ALTER TABLE `[#DB_PREFIX#]question` MODIFY COLUMN `question_detail` text CHARACTER SET utf8mb4 NULL COMMENT '问题说明' AFTER `question_content`;
ALTER TABLE `[#DB_PREFIX#]article` CHARACTER SET = utf8mb4;
ALTER TABLE `[#DB_PREFIX#]answer` MODIFY COLUMN `answer_content` text CHARACTER SET utf8mb4 NULL COMMENT '回答内容' AFTER `question_id`;
ALTER TABLE `[#DB_PREFIX#]article` MODIFY COLUMN `message` text CHARACTER SET utf8mb4 NULL AFTER `title`;